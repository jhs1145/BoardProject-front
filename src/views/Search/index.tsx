...
export default function Search() {
  ...
  // 연관 검색어 리스트 불러오기 응답 처리 함수
  const getRelationListResponseHanlder = (responsebody : GetRelationListResponseDto | ResponseDto) => {
  ...
  useEffect(() => {
    ...
    getRelationListRequest(searchWord).then(getRelationListResponseHanlder);
